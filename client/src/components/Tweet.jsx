            ...
            <div className='group w-max relative transition-all' >
                <div className='w-[268px] invisible userBoxX transition-all opacity-0 group-hover:opacity-100 z-50 group-hover:delay-500 group-hover:visible flex absolute p-4 top-12 bg-black rounded-3xl flex-col items-start' >
                    ...
                    <div className='flex items-start gap-2 w-full justify-start' >
                        <Link to={`/${user.username}/following`} className='text-sm hover:underline cursor-pointer ' ><strong> {following?.length} </strong> <span className='text-[#71767B]' >Following</span></Link>
                        <Link to={`/${user.username}/followers`} className='text-sm hover:underline cursor-pointer ' ><strong> {followers?.length} </strong> <span className='text-[#71767B]' >Followers</span></Link>
                    </div>
